...
package com.android.internal.util.descendant.ambient.play;
...
public class AmbientPlayHistoryManager {
    private static final String AUTHORITY = "org.oss.ambient.play.history.provider";
    ...
    private static String ACTION_SONG_MATCH = "com.android.internal.util.descendant.ambient.play.AMBIENT_PLAY_SONG_MATCH";
    public static Intent INTENT_SONG_MATCH = new Intent(ACTION_SONG_MATCH);
    public static final String SERVICE_PACKAGE = "org.oss.ambient.play.history";
